// clear data 
// TODO: delete WHEN data is modelled AND first batch is uploaded
MATCH (n) DETACH DELETE n; 

// load organization nodes 
LOAD CSV WITH HEADERS FROM 'https://github.com/derrabauke/eu-data-workflow/raw/main/h2020_projects_out_formatted.csv' AS row 
...
// load organization nodes
LOAD CSV WITH HEADERS FROM 'https://github.com/derrabauke/eu-data-workflow/raw/main/h2020_organizations_out_formatted.csv' AS row
...
MATCH (o:Organization {projectID: row.id}) MERGE (p)-[:PARTICIPATES_ON]->(p)
RETURN *;
